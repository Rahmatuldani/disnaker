...
class CreateIpk2sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ipk2s', function (Blueprint $table) {
            $table->integer('ipk2_id')->autoIncrement();
            $table->string('education_id', 5);
            $table->string('ipk2_month', 8);
