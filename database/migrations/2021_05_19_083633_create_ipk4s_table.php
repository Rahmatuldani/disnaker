...
class CreateIpk4sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ipk4s', function (Blueprint $table) {
            $table->integer('ipk4_id')->autoIncrement();
            $table->string('education_id', 5);
            $table->string('ipk4_month', 8);
