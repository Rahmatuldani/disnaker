...
class CreateIpk3sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ipk3s', function (Blueprint $table) {
            $table->integer('ipk3_id')->autoIncrement();
            $table->string('job_position_id', 5);
            $table->string('ipk3_month', 8);
