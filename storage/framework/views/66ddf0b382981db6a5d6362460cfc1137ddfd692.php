        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form action="<?php echo e(route('user.cpass', Auth::user()->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\disnaker\resources\views/changePass.blade.php ENDPATH**/ ?>