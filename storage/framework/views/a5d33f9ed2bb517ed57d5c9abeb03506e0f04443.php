...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.education')); ?>">
            <i class="fas fa-fw fa-tachometer-alt"></i>
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.jobPosition')); ?>">
            <i class="fas fa-fw fa-tachometer-alt"></i>
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.businessField')); ?>">
            <i class="fas fa-fw fa-tachometer-alt"></i>
...
<!-- End of Sidebar -->
<?php /**PATH E:\disnaker-master\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>