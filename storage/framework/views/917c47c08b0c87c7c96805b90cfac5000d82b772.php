...
<div class="container-fluid">
    ...
    <a href="#" class="btn btn-primary mb-4" data-toggle="modal" data-target="#addIpk5">Tambah laporan baru</a>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $ipk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-success" data-toggle="modal" data-target="#editIpk5-<?php echo e($u['ipk5_id']); ?>"><i class="fas fa-edit"></i></a>
                                    
                                </td>
                            </tr>

                            <!-- Edit Modal-->
                            <div class="modal fade" id="editIpk5-<?php echo e($u['ipk5_id']); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?php echo e(route('user.ipk5', 'edit')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <div class="modal-body">
                                                <input type="hidden" name="ipk5_id" value="<?php echo e($u['ipk5_id']); ?>">
                                                <div class="row m-3">
    ...
    <!-- Add Modal-->
    <div class="modal fade" id="addIpk5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="<?php echo e(route('user.ipk5', 'add')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\disnaker\resources\views/laporan/ipk5.blade.php ENDPATH**/ ?>