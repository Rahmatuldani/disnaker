...
<div class="container-fluid">
                    ...
                    <tbody>
                        @foreach ($ipk as $u)
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-success" data-toggle="modal" data-target="#editIpk-{{$u['ipk2_id']}}"><i class="fas fa-edit"></i></a>
                                    {{-- <a href="#" class="btn btn-danger"><i class="fas fa-trash"></i></a> --}}
                                </td>
                            </tr>

                            <!-- Edit Modal-->
                            <div class="modal fade" id="editIpk-{{$u['ipk2_id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('user.ipk2', 'edit') }}" method="POST">
                                            @csrf
                                            <div class="modal-body">
                                                <input type="hidden" name="ipk2_id" value="{{$u['ipk2_id']}}">
                                                <div class="row m-3">
    ...
    <div class="modal fade" id="addIpk2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{ route('user.ipk2', 'add') }}" method="POST">
                    @csrf
                    <div class="modal-body m-2">
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
